...
from src.providers.beacon_state.client import BeaconStateClient
...
class BeaconStateClientModule(BeaconStateClient, Module):
    def __init__(self, hosts: list[str], w3: Web3):
        self.w3 = w3

        super(BeaconStateClient, self).__init__(
            hosts,
            HTTP_REQUEST_TIMEOUT_CONSENSUS,
            HTTP_REQUEST_RETRY_COUNT_CONSENSUS,
            HTTP_REQUEST_SLEEP_BEFORE_RETRY_IN_SECONDS_CONSENSUS,
